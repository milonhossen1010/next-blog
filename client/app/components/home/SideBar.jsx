...
export default function SideBar() {
    return (
        <div className="w-full mt-7 ">
            <div className='p-3 md:p-10 border border-borderColor mb-12'>
                <Image
                    className="w-full"
            ...
            <div className="mt-16">
                ...
                <div>
                    ...
                    <div className="flex items-center mb-4 gap-4">
                        <Link className="w-1/4" href="#"><Image
                            src="https://chronicle.ancorathemes.com/wp-content/uploads/2020/01/image-101-410x430.jpg"
                            alt="Post" width={400} height={400}/></Link>
                        <div>
                            <h2><Link href="#" className="text-black text-[18px] font-heading">Street-Style Inspired
                                T...</Link>
                            </h2>
                            <span
